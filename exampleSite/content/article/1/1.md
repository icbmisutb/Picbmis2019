...
authors = [
  ...
  {surname = "Buhari",  given_name = "Mohammed",  affiliations = ["3"],  ORCID = "", funding = [], corresp = "", equalcontrib = "no", deceased = "no"},
  
]

affiliations = [{ISNI = "0000 0000 0000 0000 ", ROR = "0000xxx22", name ="Department of Business Education, Federal College of Education Katsina"}]
