...
authors = [
  ...
  {surname = "Tsagem",  given_name = "Muhammad Musa",  affiliations = ["2"],  ORCID = "", funding = [], corresp = "", equalcontrib = "no", deceased = "no"},
  {surname = "Tsagem",  given_name = "Muhammad Musa",  affiliations = ["3"],  ORCID = "", funding = [], corresp = "", equalcontrib = "no", deceased = "no"},
  {surname = "Tsagem",  given_name = "Muhammad Musa",  affiliations = ["4"],  ORCID = "", funding = [], corresp = "", equalcontrib = "no", deceased = "no"}
]
