...
authors = [
  ...
  {surname = " Ukairo",  given_name = " Ukairo Mabel",  affiliations = ["1"],  ORCID = "", funding = [], corresp = "", equalcontrib = "no", deceased = "no"}
  {surname = "Mohammed",  given_name = "Buhari",  affiliations = ["1"],  ORCID = "", funding = [], corresp = "", equalcontrib = "no", deceased = "no"}
]
